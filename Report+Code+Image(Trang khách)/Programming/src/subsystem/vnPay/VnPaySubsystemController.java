...
public class VnPaySubsystemController {
     ...
     * @return PaymentTransaction
     */
    public String generatePayOrderUrl(int money) throws IOException {

        String vnp_Version = "2.1.0";
        String vnp_Command = "pay";
        String orderType = "other";
        String contents = "Thanh toán hoá đơn";
     ...
     * @return PaymentTransaction
     */
    public PaymentTransaction makePaymentTransaction(Map<String, String> response) throws TransactionNotDoneException, TransactionFailedException, TransactionReverseException, UnrecognizedException, SQLException {
        if (response == null) {
            return null;
        }
