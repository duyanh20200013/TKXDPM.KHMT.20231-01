...
public class VnPaySubsystem implements VnPayInterface {
     ...
     * java.lang.String)
     */
    public String generatePayUrl(int amount) {

        try {
            return ctrl.generatePayOrderUrl(amount);
        } catch (IOException e) {
    ...
    public PaymentTransaction makePaymentTransaction(Map<String, String> response) throws SQLException {
