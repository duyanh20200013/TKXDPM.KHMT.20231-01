...
public class HomeScreenHandler extends BaseScreenHandler implements Initializable {
    ...
    public void handleClickInvoice(){
        InvoiceListHandler invoiceHandler;
        try {
            invoiceHandler = new InvoiceListHandler(this.stage,Configs.INVOICE_LIST_PATH);
            invoiceHandler.requestToInvoiceList(this);
            invoiceHandler.setHomeScreenHandler(this);
        } catch (IOException ex) {
            throw new RuntimeException(ex);
        } catch (SQLException ex) {
            throw new RuntimeException(ex);
