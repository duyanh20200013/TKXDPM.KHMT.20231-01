...
public class InvoiceListHandler extends BaseScreenHandler {
    ...
    private final ArrayList<PaymentTransaction> dataInvoice;

    @FXML
    private ImageView aimsImage;

    @FXML
    private TableView<PaymentTransaction> tableView;

    @FXML
    private TableColumn<PaymentTransaction, Integer> sttColumn;

    @FXML
    private TableColumn<PaymentTransaction, String> idColumn;

    @FXML
    private TableColumn<PaymentTransaction, Integer> amountColumn;

    @FXML
    private TableColumn<PaymentTransaction, String> statusColumn;

    @FXML
    private TableColumn<PaymentTransaction, Button> invoice_custom;

    public InvoiceListHandler(Stage stage, String screenPath) throws IOException, SQLException {
        super(stage, screenPath);

        dataInvoice = new PaymentTransaction().getListPaymentTransaction();
    ...
    private void initializeTableColumns() {
        ...
        statusColumn.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getTransactionContent()));
...
//    }
    ...
    private void populateTable() {
        ...
        ObservableList<PaymentTransaction> observableData = FXCollections.observableArrayList(dataInvoice);
